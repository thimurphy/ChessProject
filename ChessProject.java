	...
	private Boolean checkWhiteOponent(int newX, int newY){
		...
		if(((tmp1.contains("Black")))){
            if((tmp1.contains("King"))){
                JOptionPane.showMessageDialog(null, "White Wins!", "Message!", JOptionPane.INFORMATION_MESSAGE);
	...
	*/
    private Boolean checkBlackOponent(int newX, int newY){
        ...
        if(((tmp1.contains("White")))){
            if((tmp1.contains("King"))){
                JOptionPane.showMessageDialog(null, "Black Wins!", "Message!", JOptionPane.INFORMATION_MESSAGE);
	...
	*/
    public void mouseReleased(MouseEvent e) {
		...
		*/
        ...
        Goes sideways - diagonally
        ((Math.abs(startY-landingY) == 1) && (Math.abs(startX - landingX) == 1))
        ...
        */
        ...
        if(pieceName.contains("King")){
            if(((landingX < 0) || (landingX > 7)) || ((landingY < 0) || (landingY > 7))){
                ...
                if(((Math.abs(startY-landingY) == 1) && (Math.abs(startX - landingX) == 1)) || ((startY - landingY) == 1) || ((startX - landingX) == 1) || ((xMovement == 1) && (yMovement == 0)) || ((yMovement == 1) && (xMovement == 0)))
                {
                        ...
                        if(piecePresent(e.getX(), e.getY())){
                            if(pieceName.contains("White")){
                                if(checkWhiteOponent(e.getX(), e.getY())){
                                    ...
                                    validMove = false;
                                }// end if Check for white oponent 
                            }else{
                                if(checkBlackOponent(e.getX(), e.getY())){
                                    ...
                                    validMove = false;
                                }//end if check for black oponent
                            }
                        }else{
                            validMove = false;
                        }
                    }//end if there is not a piece present 
                }//end if moving 1 diagonally, vertically and horizontally
                else{
                    if(piecePresent(e.getX(), e.getY())){
        ...
        //Enable the queen
            ...
            }//end of if statement - piece on the board
        ...
        //Bishup piece
            ...
            if(((landingX < 0) || (landingX > 7)) || ((landingY < 0) || (landingY > 7))){
                ...
                }//end of math if statement
                else{
                     validMove = false;
                }
            }
        }// end of bishop if statement.
        
        
        
        //Knight piece White and Black
        else if(pieceName.contains("Knight")){
            
            //Check if the piece is not out of the board
            if(((landingX < 0) || (landingX > 7)) || ((landingY < 0) || (landingY > 7))){
                validMove = false;
            }else{
		...
		if(pieceName.equals("WhitePawn")){
			...
			if(startY == 1)
			{
				...
				{
					if((Math.abs(landingX - startX) == 1)&&(((landingY - startY)==1)))
					{
                        if(piecePresent(e.getX(), (e.getY()))){
                            if(checkWhiteOponent(e.getX(), e.getY())){
							validMove = true;
